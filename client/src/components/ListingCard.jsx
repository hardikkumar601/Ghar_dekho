    ...
    >
      <div className="slider-container w-medium">
        <div className="slider flex">
          ...
          >
            <img className="h-6 w-6" src="../public/ifgb/chevron.png" />
          </button>
          <button
          ...
          >
            <img className="h-6 w-6" src="../public/ifgb/right.png" />
          </button>
        </div>
      </div>
      ...
      >
        {isLiked ? (
          <img className="h-6 w-6" src="../public/ifgb/like.png" />
        ) : (
          <img className="h-6 w-6" src="../public/ifgb/love.png" />
        )}
      </button>
    </div>
  </div>
