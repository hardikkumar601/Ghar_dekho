    ...
    <nav className="bg-white shadow-lg">
      <div className="max-w-8xl  mx-auto px-4">
        <div className="flex justify-between">
          ...
          <div className="flex  w-80 my-3 mx-10  rounded-full border-2 border-gray-600  bg-transparant md:my-4 ">
            <input
            ...
            >
              ...
              <div className="relative w-9 h-9 mt-1 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                {!user ? (
                  ...
                  <img
                    src={`http://localhost:3000/${user.profileImage.replace("public","")}`}
                    alt="user profile"
                    className="absolute object-cover w-full h-full rounded-full"
                  />
                )}
        ...
        {user && isOpen && (
          <div className="mobile-menu ">
            ...
            <Link to="/create-listing" className="block py-2 px-4 text-sm hover:bg-gray-200">Become A Host</Link>
            <Link
              to ="/login"
              className="block py-2 px-4 text-sm hover:bg-gray-200"
              onClick={() => {
